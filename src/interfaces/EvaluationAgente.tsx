import "../styles/EvaluationAgente.css";
           ...
           <div className="content-progress">
                ...
                <li>
                    ...
                    <div className="progress-result">
                        ...
                        <div className="result-grafico">
                            <progress value="10" max="10"><strong>Progreso:</strong> 7,5/10</progress>
                        </div>
                        <div className="result-pie">
                            <div>
                                <p className="plomo">5/5</p>
                ...
                <li>
                    ...
                    <div className="progress-result">
                        ...
                        <div className="result-grafico">
                            <progress value="3.5" max="10"><strong>Progreso:</strong> 7,5/10</progress>
                        </div>
                        <div className="result-pie">
                            <div>
                                <p className="plomo">5/5</p>
